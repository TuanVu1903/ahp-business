...
def export_pdf():
    ...
    try:
        ...
        # Title - giữ nguyên tiếng Việt
        title_text = f"Phân tích AHP: {goal}"
        ...
        if sorted_alternatives:
            ...
            conclusion_text = f"Kết luận: Phương án {best_alt} là lựa chọn tốt nhất với điểm số {best_score:.4f} ({percentage:.2f}%)."

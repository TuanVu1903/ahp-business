...
def export_pdf():
    ...
    try:
        ...
        # Setup fonts - use default ReportLab fonts instead of custom fonts
        from reportlab.pdfbase import pdfmetrics
        from reportlab.pdfbase.ttfonts import TTFont
        import os

        # Use Helvetica family instead of DejaVu
        ...
        # Enhanced custom styles for enterprise look - using default fonts

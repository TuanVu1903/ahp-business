...
def export_pdf():
    ...
    try:
        ...
        if os.path.exists(bold_font_path):
            ...
            print("Warning: DejaVuSans-Bold.ttf not found, using DejaVuSans for bold text")
        ...
        styles.add(ParagraphStyle(
            ...
            fontWeight='bold', borderColor=corporate_blue, 
        ...
        styles.add(ParagraphStyle(
            ...
            borderPadding=0.3*cm, borderWidth=1, 
            borderColor=corporate_gray, borderRadius=5
        ))
        styles.add(ParagraphStyle(
            ...
            leftIndent=0.5*cm, rightIndent=0.5*cm, 
            borderPadding=0.3*cm, borderWidth=1, 
            borderColor=corporate_green, borderRadius=5
        ))
        styles.add(ParagraphStyle(
        ...
        # Company header
        elements.append(Paragraph("BÁO CÁO PHÂN TÍCH QUYẾT ĐỊNH", styles['CompanyHeader']))
        
        # Report title
        elements.append(Paragraph(f"PHÂN TÍCH PHƯƠNG PHÁP AHP", styles['ReportTitle']))
        elements.append(Spacer(1, 0.2*cm))
        
        # Report subtitle with goal
        elements.append(Paragraph(f"{goal}", styles['ReportSubtitle']))
        ...
        Mục tiêu của phân tích là "{goal}".
        """
        elements.append(Paragraph(summary_text, styles['ExecutiveSummary']))
        
        # Section: Criteria Weights
        elements.append(Paragraph("1. TRỌNG SỐ CÁC TIÊU CHÍ", styles['SectionHeader']))
        elements.append(Spacer(1, 0.2*cm))
        ...
        elements.append(Paragraph("2. KẾT QUẢ PHÂN TÍCH CUỐI CÙNG", styles['SectionHeader']))
        elements.append(Spacer(1, 0.2*cm))
        ...
        if len(criteria) > 1 and len(alternatives) > 1:
            elements.append(Paragraph("3. PHÂN TÍCH CHI TIẾT", styles['SectionHeader']))
            elements.append(Spacer(1, 0.2*cm))
        ...
        signature_data = [
            [Paragraph('Người phê duyệt:', styles['TableCell']), 
             Paragraph('Người thực hiện:', styles['TableCell'])],
            ...
            [Paragraph('', styles['TableCell']), 
             Paragraph('', styles['TableCell'])],
            [Paragraph('(Ký, ghi rõ họ tên)', styles['TableCellCenter']), 
             Paragraph('(Ký, ghi rõ họ tên)', styles['TableCellCenter'])]
        ]
        ...
        def add_page_number(canvas, doc):
            ...
            canvas.drawRightString(doc.width + doc.leftMargin - 0.5*cm, 1*cm, f"Trang {page_num}")

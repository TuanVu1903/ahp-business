...
def export_pdf():
    ...
    try:
        ...
        if sorted_alternatives:
            ...
            phương án <b>{html.escape(best_alt)}</b> được đánh giá là phù hợp nhất với điểm số <b>{best_score:.4f}</b> 
            ...
            if len(sorted_alternatives) > 1:
                ...
                conclusion_text += f"""
                <para alignment=\"justify\">
                So với phương án xếp hạng thứ hai (<b>{html.escape(second_alt)}</b>), phương án được chọn có điểm số cao hơn 
        ...
        <br/>
        <bullet>•</bullet> Ưu tiên triển khai phương án <b>{html.escape(sorted_alternatives[0])}</b>
        <br/>

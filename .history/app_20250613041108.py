...
def export_excel():
    ...
    try:
        ...
        # 6. Signature Section
        elements.append(Paragraph("6. CHỮ KÝ VÀ PHÊ DUYỆT", styles['CorporateSectionHeader']))
...
def export_pdf():
    ...
    try:
        ...
        signature_data = [
            ...
            [session.get('username', 'Admin'), "Cấp trên"]
        ]
        ...
        # Add date
        elements.append(Spacer(1, 20))
        elements.append(Paragraph(f"Ngày: {datetime.now().strftime('%d/%m/%Y')}", styles['CorporateBodyText']))

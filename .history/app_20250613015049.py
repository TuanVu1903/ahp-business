...
def export_pdf():
    ...
    try:
        ...
        elements.append(Paragraph("PHƯƠNG PHÁP PHÂN TÍCH THỨU BẬC (AHP)", styles['CorporateCoverSubHeader']))
        elements.append(Spacer(1, 20))
        elements.append(HRFlowable(width=450, color=ACCENT_COLOR, thickness=2))
        
        elements.append(Spacer(1, 40))
        elements.append(Paragraph(f"<b>{goal}</b>", styles['CorporateCoverSubHeader']))

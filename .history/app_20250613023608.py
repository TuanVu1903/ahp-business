...
def export_pdf():
    ...
    try:
        ...
        para2 = f"""<para alignment=\"justify\">Phân tích được thực hiện dựa trên <b>{len(criteria)} tiêu chí</b> và <b>{len(alternatives)} phương án</b> thay thế. Kết quả phân tích sẽ cung cấp cơ sở khoa học để đưa ra quyết định tối ưu dựa trên các tiêu chí đã xác định.</para>"""

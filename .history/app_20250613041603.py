...
def export_excel():
    ...
    try:
        ...
        signature_data = [
            [Paragraph("<b>Cấp trên phê duyệt:</b>", styles['CorporateBodyText']), Paragraph("<b>Người thực hiện phân tích:</b>", styles['CorporateBodyText'])],
            [Paragraph("<br/><br/><br/>___________________________<br/>(Ký, ghi rõ họ tên)", styles['CorporateBodyText']), Paragraph("<br/><br/><br/>___________________________<br/>(Ký, ghi rõ họ tên)", styles['CorporateBodyText'])]
        ]
        ...
        # Add date
        elements.append(Spacer(1, 20))
        date_text = f"<para alignment=\"center\">Ngày: {datetime.now().strftime('%d/%m/%Y')}</para>"
...
def export_pdf():
    ...
    try:
        ...
        # Signature placeholders
        signature_data = [
            ["<b>Cấp trên phê duyệt:</b>", "<b>Người thực hiện phân tích:</b>"],
            ["<br/><br/><br/>___________________________<br/>(Ký, ghi rõ họ tên)", "<br/><br/><br/>___________________________<br/>(Ký, ghi rõ họ tên)"]
        ]
